...
import com.aponl.apfacesdk.Listener.UploadFaceListener;
import com.aponl.apfacesdk.Model.APUpload;
...
public class AddUserActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        super.onResume();
        FaceCRM.getsInstance().startCamera(AddUserActivity.this,
...
//        FaceCRM.getsInstance().stopCamera();
    ...
    private void uploadImage(final String base64, final int numberImage) {
        FaceCRM.getsInstance().callFaceUploadApi(base64, clientId, new UploadFaceListener() {
            @Override
            ...
            public void onUploadFaceFail(String message) {
                ...
                Toast.makeText(AddUserActivity.this, "Upload image face fail", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
