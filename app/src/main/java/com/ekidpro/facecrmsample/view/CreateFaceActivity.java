...
public class CreateFaceActivity extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback {
...
//                arrData = byteArrayOutputStream.toByteArray();
                ...
                Glide.with(CreateFaceActivity.this).load(mBitmap).into(imageView);
                refreshCamera();
            }
        };
    }
